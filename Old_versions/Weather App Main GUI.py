...
class WeatherApp(Tk):
    def __init__(self):
        ...
        self.config(bg="#CAE4D8", bd=4, relief="groove")
        ...
        self.style.configure("my.TText", background="#7A9D96", fg="#DCAE1D", anchor=CENTER)
        ...
        self.e1 = tk.Entry(self.loc_frame, textvariable=self.e1_val, background="#CAE4D8", fg="#00303F", width=46)
...
#        self.button_clear_hover_img = PhotoImage(#file=r"Resources\Buttons\clear_entry_hover.png")
        ...
        # status / error bar
        self.l_status = Label(self.text_frame, textvariable=self.var_status, width=60, style="my.TLabel")
