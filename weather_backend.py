...
class Report(object):
    ...
    Args:
        object -- The class inherits from Python base object.
    """
    ...
    def get_report(self, location, units):
        ...
        self.location = self.location.translate(translator)
        ...
        # TODO: ADD COLLECTION OF ALL TYPES OF REPORT AT ONE GO.
        # REMEMBER TO ERROR CHECK EVERY TIME. USE A FOR LOOP.
        # STORE DATA AND IN CASE OF A FAILURE WITH FURTHER REPORTS PRESENT WHAT WE MANAGED TO OBTAIN.
